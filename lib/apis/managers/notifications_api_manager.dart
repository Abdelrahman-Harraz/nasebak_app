...
import 'package:nasebak_app/apis/models/notifications/notification_wrapper.dart';
...
class NotificationsApiManager {
  ...
  Future<void> notificationsApi(
    void Function(NotificationWrapper) success,
    void Function(ErrorApiModel) fail,
  ) async {
    await dioApiManager.dio
        .get(ApiKeys.notificationsUrl)
        .then((response) {
          Map<String, dynamic> extractedData =
              response.data as Map<String, dynamic>;
          NotificationWrapper wrapper = NotificationWrapper.fromJson(
            extractedData,
          );
