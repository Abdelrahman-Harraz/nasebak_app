...
import 'package:nasebak_app/utils/loaders/pagination_loader_widget.dart';
import 'package:nasebak_app/utils/screen_scrolling/scroll_to_hide_widget.dart';
    ...
    if (widget.supportPaging!) {
      ...
      return Column(
        children: [
          ...
          PaginationLoaderWidget(isLoading: widget.showPagingLoader!),
        ],
      );
    } else {
